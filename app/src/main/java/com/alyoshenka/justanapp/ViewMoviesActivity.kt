    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val movieData = arrayOf(
            ...
            arrayOf(
                ...
                "Directed by Dario Argento protegeMichele Soavi, Cemetery Man (or Dellamorte Dellamore) is a weird, wild head trip of a movie that treats the living dead as more of a nuisance than a deadly threat. Based on the comic series Dylan Dog, Cemetery Man stars Everett as Francesco Dellamorte, a misanthropic gravedigger who prefers the company of the dead to the living. And why wouldnâ€™t he? The living are assholes and they keep spreading rumors heâ€™s impotent. Thereâ€™s just one catch â€” the dead wonâ€™t stay burried in his graveyard. When he meets a stunning widow (Falchi) at her husbandâ€™s funeral, Dellamorte falls head over heels, courts her in the morbid halls of his ossuary, and before you know it, theyâ€™re stripped naked and steaming it up on top of her dead husbandâ€™s grave. Thatâ€™s just the start of things getting weird. \nDellamorte descends into madness, and the further he falls the more Cemetery Man threatens to go off the rails, leaving logic behind in favor of a slipstream psychosis. The result is a bit of a mess without a plot to speak of, but a gloriously weird mess it is. Saturated with philosophy and offbeat humor, Cemetary Man is all about sex and death, friendship and deception; a surrealist, satirical and stylish trip to the brink loaded with splendid visuals and a knockout performance from Everett that takes him from a strapping hero to spitting psychopath. â€” Haleigh Foutch"
            ),
            arrayOf(
                "28 Weeks Later",
                "2007",
            ...
            arrayOf(
                ...
                "Rarely do zombies get the animated treatment (rarer still, stop-motion animation), and even if they do, theyâ€™re traditionally made the villains. LAIKA is anything but traditional, which makes their films so endearing, unique, and memorable. ParaNorman, one of the stop-motion studioâ€™s handful of original films, manages to not only (re)animate some truly gruesome and decaying corpses, but to give them a voice and agency within the story. Most live-action movies canâ€™t even achieve that much. \nBut what truly makes ParaNorman a great zombie tale is that the zombies themselves are more than just part of the spooky story (along with witches, ghosts, and dark magic), theyâ€™re a similar stand-in for societal problems first addressed by Romeroâ€™s original undead flick. Without giving away too many spoilers, the zombies themselves are reanimated townsfolk from colonial times who have realized the error of their ways but are prevented from setting things right thanks to a witchâ€™s curse. Because they canâ€™t communicate, theyâ€™re set upon by an angry mob. While youâ€™d expect that turn of events in a traditional monster movie, the twist in ParaNorman is what lends some substance to its overall message. As a bonus, itâ€™s a zombie movie you can watch with the kids! â€“ Dave Trumbore"
            ),
            arrayOf(
                "Zombieland",
                "2009",
                ...
                "One of the greatest enjoyments of horror cinema in the last few decades has been watching filmmakers who grew up knowing the rules of the genre find new and exciting ways to subvert them. Shaun of the Dead is the gold star of self-referential cinematic love letters, but Ruben Fleischerâ€™s Zombieland is a rollicking comedy horror in its own right.\nZombieland arrived in theaters in 2009, towards the end of a new zombie boom, and itâ€™s a film made for audiences who already know the rules and want to have some fun playing the game. The script comes from Deadpool screenwriters Reese and Wernick, and both properties share the duoâ€™s knack for genre deconstruction and razor-sharp, smart-mouthed humor. The ensemble comedic performers has a blast doling out verbal beatdowns in between actually beating down the undead. And letâ€™s be honest â€” even if Zombieland wasnâ€™t an all-around fun and entertaining action horror, it deserves a spot on the list for giving BIll Murray the most Bill Murray cameo of all time. â€” Haleigh Foutch"
            ),
            arrayOf(
                "Planet Terror",
                "2007",
            ...
            arrayOf(
                ...
                "The concluding chapter in Romeroâ€™s original â€œDeadâ€ trilogy, Day of the Dead has never found the frenzied fans of its two predecessors. In fact, itâ€™s often been met with some harsh criticisms, which is unfortunate because itâ€™s a staggering zombie film in its own right. Perhaps its the idea of sentient zombies, a tenet of Romeroâ€™s later â€œDeadâ€ films introduced in Day of the Dead via Bub, the loveable flesh-hungry fiend who begins to show signs of cognizance during military testing. Or maybe itâ€™s the script, which turns up the volume on Romeroâ€™s trademark cultural critique until the skewering tips over into preachy territory.\nBut hereâ€™s the thing, while other filmmakers may have been happy to recreate the formula that worked for them in the past, Romero consistently evolved his living dead films, and Day of the Dead was the boldest of them all. Set on a military base, Romero gets downright political, asking hard questions about power and how much any one organization should or can ever have. Itâ€™s a pensive film, not quite as primal as Night of the Living Dead and nowhere near as funny as Dawn of the Dead, which makes it a slow watch. But hoo boy, if you came for zombie gore, is the payoff rewarding. Day of the Dead has some of the most stomach-churning, sticky practical effects in the history of horror, practically painting the sterile military base red in the final act.  â€” Haleigh Foutch"
            ),
            arrayOf(
            ...
            arrayOf(
                ...
                "There just are not enough quality movie adaptations of H.P. Lovecraftâ€™s works out there today. One of the best happens to be this tale, taken from Lovecraftâ€™s early-1920s horror short, â€œHerbert Westâ€“Reanimator.â€ This tale was one of the first instances of zombies as scientifically reanimated corpses driven by primal needs. Re-Animator certainly takes that premise to the extreme in the film that launched a trilogy and became a cult classic.\nCentering on Herbert West, a medical student of questionable morals whoâ€™s developed a re-animating serum, Re-Animator is a tongue-in-cheek zombie film that is not afraid to push the envelope. Zombie cats and a reanimated severed head, violation of corpses in the morgue, gruesome deaths by decapitation and bone-saw, sexual assault by zombie, and a rather gory final battle. Itâ€™s definitely not for the faint of heart of easily offended, but for the completionists among you, itâ€™s a must-watch. (There is an R-rated cut, though Gordon himself prefers the unrated version if that helps you decide one way or the other.) -  Dave Trumbore"
            ),
            arrayOf(
                "Zombi 2",
                "1971",
            ...
            arrayOf(
                ...
                "These days, Zack Snyder is known for being the architect of Warner Bros.â€™ DC Comics live-action movie universe, but it was not always that way. Before Man of Steel, Watchmen, or even his claim to fame 300, Snyder turned in a terrifying modernized account of Romeroâ€™s 1978 original by the same name. (Oddly enough, Marvel movie-maker James Gunn also contributed his screenwriting talent to this film.)\nThe most memorable aspect of Snyderâ€™s version? Fast zombies. Theyâ€™re terrifying. Sure, it wasnâ€™t the first film to implement the twist on Romeroâ€™s modern zombie, but Snyderâ€™s take on the fast zombies were quite the surprise since they appeared in the â€œNight of the Living Deadâ€ universe. By the time that Dawn of the Dead had arrived in theaters, zombie movie fans thought they had seen enough to prepare themselves for â€œwhat they would doâ€ should the zombie apocalypse come to pass. Once Snyderâ€™s first fast zombie ran after its living meal, those plans went out the window. I also have a soft spot for the baby zombie and the fat woman in the wheelbarrow (played by Chris Farleyâ€™s Tommy Boy stunt double Ermes Blarasin), as well as the fantastic and surprisingly capable cast assembled for this film. If youâ€™ve written this one off or have never seen it, definitely put it on your list. â€“ Dave Trumbore"
            ),
            arrayOf(
            ...
            arrayOf(
                ...
                "Peter Jackson could have only made this gory, gushy, and occasionally outright repulsive zombie film, and he would still be a kind of legend, if not at the level of the man who brought Lord of the Rings to the big-screen. Dead Alive openly toys with one of horrorâ€™s most cherished concepts â€“ repression â€“ and when Lionelâ€™s (Balme) love for a local girl is no longer held down by his controlling mother (Moody), out come the decaying zombie-like creatures to act as a horrifying expression of mommaâ€™s villainous control. Like Tobe Hooper and Stuart Gordonâ€™s iconic 1980s output, Dead Alive (also known as Braindead) strives for what Hooper called â€œred humor,â€ a melding of slapstick and physical comedy with horror, and the result is the most idiosyncratic and zany effort that Jackson produced, complete with zombie-monster momma and rotted ears and noses garnishing a nice Sunday chowder. â€” Chris Cabin"
            ),
            arrayOf(
                "28 Days Later",
                "2002",
                ...
                "28 Days Later redefined the zombie aesthetic for a generation of filmmakers. Directed by Oscar-winner Danny Boyle from a script by brilliant sci-fi scribe Alex Garland, 28 Days Later rubbed zombie purists the wrong way at first. For one thing, they werenâ€™t technically zombies but humans infected with a feral rage virus, and as a result, they moved way too fast. Purists scoffed, but audiences around the world discovered a new approach to the beloved genre that has not only endured but become one of the most influential modern entries in the genre.\nBoyle crafted a new image of the viral apocalypse, a savage, bloodthirsty virus that sweeps through the world leaving a broken, infested shell behind. Thatâ€™s what Jim (Murphy) awakes to find, rising from a coma to discover England in ashes. Boyle captures the chaos and the terror of a world destroyed with his signature stylistic flourishes â€” quick edits and skewed color palettes that enhance the adrenaline-fuelled fear that engulfs the first act. From there, the film settles into an intimate character drama set against the backdrop of collapsed society and the fringe groups that try to hold on to their sense of normalcy.  28 Days Later is so successful because it is as tender as it is terrifying, matching moments of horror with humanity, and a healthy spattering of cultural commentary along the way. â€” Haleigh Foutch"
            ),
            arrayOf(
                ...
                "Night of the Living Dead is not the first zombie movie; far from it. But itâ€™s the first to leave traditional voodoo roots behind, move beyond using atomic radiation (more or less), and do away with alien invasions to give us the modern version of zombies as reanimated corpses who hunger for flesh. For the last 50 years and counting, thatâ€™s the model that zombie stories in all media have been built from, including Romeroâ€™s own sequels to his seminal film.\nAnd yet the original still holds up today, not because of dazzling special effects or incredible acting but because of the social themes Night of the Living Dead attempted to skewer. The undercurrents of racial prejudice, vigilantism, mob mentality, and cowardice in the face of difficulty continue to hit hard 50 years later since these themes are common human attributes throughout history that weâ€™re still attempting to overcome today. In subverting everything that defines life as a human, Romero was able to explore humanity at its least humane. Often imitated, rarely duplicated, Night of the Living Dead remains a contemporary horror classic. â€“ Dave Trumbore"
            ),
            arrayOf(
                "Shawn of the Dead",
                "2004",
                ...
                "When it comes to advancing the zombie movie genre, this film stands out among the crowd. Itâ€™s both a warm-blooded love letter to the history of zombie films and a stone-cold laugher that takes shots at those very same films. It helped quite a bit that Wright and Pegg enjoyed a shorthand from working together on the TV series Is It Bill Bailey? and Spaced before collaborating on what is arguably the best zombie comedy out there today.\nShaun of the Dead didnâ€™t just take the zombie movie tropes and run with them, it allowed Wrightâ€™s meticulous attention to detail and brand of humor, complemented by Peggâ€™s delivery, to bubble to the surface. Itâ€™s one of the most re-watchable movies out there because youâ€™ll always find something new that you may have missed dozens of times before. And once youâ€™ve steeped yourself in the history of zombie films, you should also find that you have a new appreciation for just how lovingly Shaun of the Dead was put together. â€“ Dave Trumbore"
            ),
            arrayOf(
                "Dawn of the Dead",
                "1978",
                ...
                "George Romero didnâ€™t invent the zombie, but he did single-handedly create the template for the modern zombie movie as we know it with his exquisite Night of the Living Dead. For his sequel, Romero dodged the temptation to retread familiar territory (a quality he would maintain for each of his subsequent â€œdeadâ€ films), ditching the intimate confines of a home for the sprawling reaches of a shopping mall, and trading his black-and-white bleakness for a playful color-saturated palette.\nDawn of the Dead is a horror sequel in every sense, bigger and bloodier, but it maintainâ€™s Romeroâ€™s commitment to piercing social commentary, this time tackling the insatiable lust of American consumerism. Itâ€™s also packed to the brim with Romeroâ€™s skilled eye for visceral violence rendered with first-rate old-school gore effects from Tom Savini, the legendary craftsman of carnage who transplanted his experience as a combat photographer in Vietnam to a career spent creating on-screen nightmares. As in all of Romeroâ€™s great work, that beautifully executed bloodshed is only a backdrop for a compelling character drama as the group of strangers seeking refuge in the abandoned shopping complex cope with increasing interpersonal conflict. Romero directs it all with wit and empathy, and an expert eye for when to drop the next big scare. â€” Haleigh Foutch"
            )
        )
        val movies = ArrayList<Movie>()
        for (movie in movieData) {
            movies.add(Movie(movie[0], movie[1], movie[2], movie[3], movie[4]))
        }

        Log.d("testing", "arr")

        val recycler = findViewById<RecyclerView>(R.id.movie_recycler_view)
        Log.d("testing", "rec")
        assert(null != recycler)
        Log.d("testing", "hit")
        val adapter = MovieViewAdapter(movies, ::viewMovie)
        recycler.layoutManager = LinearLayoutManager(this)
        recycler.adapter = adapter
    }

    public fun viewMovie(data: Movie) {
        intent = Intent(this, ViewMovieDetailsActivity::class.java)

        intent.putExtra("title", data.title)
        intent.putExtra("year", data.year)
        intent.putExtra("director", data.director.ifEmpty { "Unlisted" })
